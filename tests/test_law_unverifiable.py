...
from apkradar.cli import _print_law_check
from apkradar.law_checker import ActStatus, Citation, LawCheckResult
from apkradar.law_fetcher import GDPR
...
def law(source: str, *, sha256: str | None) -> LawCheckResult:
    return LawCheckResult(
        citations=[Citation(finding="sensitive", law=GDPR.name, article="32(1)",
